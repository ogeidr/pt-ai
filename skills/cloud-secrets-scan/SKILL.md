...
!`cat /work/scope.md 2>/dev/null || echo "No scope declared yet. Run /scope-declare before scanning any bucket, repo, or account."`
...
markdown summary with the Write tool:
